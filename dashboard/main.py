...
if dashboard_auto_refresh_enabled:
    ...
    st.caption(
        "Auto refresh watches the Stored Tweets count in the database and reloads only "
        f"when it increases (checked every {max(dashboard_auto_refresh_seconds, 5)} seconds)."
    )
